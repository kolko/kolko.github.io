...
Хороший курс лекций, охватывающий большой набор тем, интересный разрабочикам высоконагруженных систем: от веб-архитектуры, построение кластеров, распределение нагрузки до архитектуры процессоров и особенностей железа серверов. А также вопросы менеджмента датацентров, мониторинг и работы с инцидентами.
...
Отмечу, что лекции основаны на опыте реальных людей из одноклассников, в лекциях не просто "архитектуры в вакууме" или темы из книжек, а настоящий опыт с ретроспективой и реальными проблемами.
