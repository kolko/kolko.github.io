...
Принципы, которых мы придерживаемся при разработке и ревью архитектуры:
  * Skill -1. Просто крутому разработчику сделать сложную систему, сложно потом нанять команду таких же крутых разработчиков для ее поддержки. Подробнее правило 3.1 на http://opencarbon.ru/open_carbon_7:аксиомы
